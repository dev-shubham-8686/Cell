...
const ReportFormPage = () => {
  ...
  const [isAmendReSubmitTask, seIsAmendReSubmitTask] =
  ...
  const [existingAdjustmentReport, setexistingAdjustmentReport] =
    React.useState<any>(null);
  ...
  const items: TabsProps["items"] = [
    ...
    },
    {
      ...
      children: (
        <Workflow
          status={reportData?.ReturnValue?.Status}
          submitted={reportData?.ReturnValue?.IsSubmit}
          approverTasks={approvalData ? approvalData : []}
          advisorId={reportData?.ReturnValue?.AdvisorId}
        />
      ),
    },
  ];
    ...
    <div>
      {true && (
        <WorkFlowButtons
          ...
          departmentHead={
            existingAdjustmentReport?.DepartmentHeadId == user?.employeeId
          }
          depDivHead={
            existingAdjustmentReport?.DeputyDivHead == user?.employeeId
          }
        />
      )}
    </div>
