...
export default class AdjustmentReportWebPart extends BaseClientSideWebPart<IAdjustmentReportWebPartProps> {
  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = "";

  public render(): void {
    const element: React.ReactElement<IAdjustmentReportProps> =
      React.createElement(AdjustmentReport, {
