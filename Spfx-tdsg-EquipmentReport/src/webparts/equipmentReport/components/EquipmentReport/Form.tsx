            ...
            <div className="row ">
              ...
              <div className="col">
                ...
                >
                  <Select
                    disabled={
                      isModeView || (submitted && !underAmmendment)
                      //  ||
                      // (pcrnSubmission &&
                      //   existingEquipmentReport?.Status !=
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      ...
                      >
                        <DatePicker
                          ...
                          disabled={isModeView || resultsubmitted}
                    ...
                    <div className="col">
                      ...
                      >
                        <DatePicker
                          format={DATE_FORMAT}
                          disabled={
                            isModeView || !enableActualDate || resultsubmitted
                          }
                          className="w-100"
                        />
                      </Form.Item>
                    ...
                    <div className="col">
                      ...
                      >
                        <TextArea
                          disabled={
                            isModeView || !enableResultStatus || resultsubmitted
                          }
                          className="w-100"
                          rows={1}
                          maxLength={1000}
