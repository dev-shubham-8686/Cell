...
import * as strings from 'EquipmentReportWebPartStrings';
...
export default class EquipmentReportWebPart extends BaseClientSideWebPart<IEquipmentReportWebPartProps> {
