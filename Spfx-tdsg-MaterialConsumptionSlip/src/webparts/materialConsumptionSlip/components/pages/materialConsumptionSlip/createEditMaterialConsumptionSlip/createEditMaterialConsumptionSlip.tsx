...
> = ({
  ...
  setIsFormModified,
    ...
    console.log("first", user.isAdmin, submitted, currentApproverTask, user.employeeId, (user.isAdmin ||
      (!submitted ||
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <>
                                  <Select
                                    ...
                                    className={` custom-disabled-select w-90 ${error ? "ant-select-status-error" : ""
                                      }`}
                                    onChange={(value) => {
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <>
                                  <Input
                                    ...
                                    maxLength={50}
                                    {...field}
                                    className={`w-90 ${error ? "ant-input-status-error" : ""
                                      }`}
                                  />
                                  {error && (
                                    <div className="form-field-error">
                              ...
                              render={({ field, fieldState: { error } }) => (
                                <>
                                  <InputNumber
                                    ...
                                    precision={2}
                                    className={`custom-disabled-input w-90 ${error ? "ant-input-number-status-error" : ""
                                      }`}
                                  />
                                  {error && (
                                    <div className="form-field-error">
