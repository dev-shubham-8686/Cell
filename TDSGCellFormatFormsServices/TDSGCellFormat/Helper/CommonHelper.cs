...
namespace TDSGCellFormat.Helper
{
    public class CommonHelper
    {
        ...
        {
            var user = _context.CellSubstituteMasters.Where(x => x.EmployeedID == userId && (x.FormName == formname) && (x.DateFrom <= DateOnly.FromDateTime(System.DateTime.Today) && x.DateTo >= DateOnly.FromDateTime(System.DateTime.Today)) && x.IsSubstitute == true).FirstOrDefault();
