...
namespace TDSGCellFormat.Interface.Repository
{
    public interface ITechnicalInsurtuctionRepository : IBaseRepository<TechnicalInstructionSheet>
    {
        ...
        Task<string> GetTechnicalInstructionApproverList(int createdBy, int skip, int take, string order, string orderBy, string searchColumn, string searchValue);
        ...
        Task<IEnumerable<TechnicalAttachmentAdd>> GetTechnicalAttachmentList(int TechnicalId);
        ...
        Task<string> GetReviseDataListing(int technicalId);
