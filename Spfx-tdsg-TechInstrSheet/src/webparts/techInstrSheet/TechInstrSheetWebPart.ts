...
import * as strings from 'TechInstrSheetWebPartStrings';
...
export default class TechInstrSheetWebPart extends BaseClientSideWebPart<ITechInstrSheetWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ITechInstrSheetProps> = React.createElement(
      TechInstrSheet,
      {
