...
import {
  TECNICAL_API_SERVICE_URL,
  TECNICAL_ROOT_SERVICE_URL,
...
export const getEquipmentMasterList = (): Promise<any> => {
  return http
    .get(`${API_URL}/GetEquipmentMasterList`)
    .then((response) => {
      return response.data; // Return the data from the response
    })
    .catch((error) => {
...
export const deleteTechnicalAttachment = (
  TechnicalAttachmentId: string
): Promise<any> => {
  return http
    .delete(`${API_URL}/TechnicalAttachment`, {
...
export const createTechnicalAttachment = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/CreateTechnicalAttachment`, data, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const updateApproveAskToAmend = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/UpdateApproveAskToAmend`, null, { params: { ...data } })
    .then((response) => {
      return response.data; // Return the data from the response
    })
    .catch((error) => {
...
export const pullBack = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/PullBack`, null, { params: { ...data } })
...
export const getCurrentApprover = (
  ...
  return http
    .get(`${API_URL}/GetCurrentApprover`, {
...
export const getApprorverFlowData = (technicalId: string): Promise<any> => {
  return http
    .get(`${API_URL}/GetApprorverFlowData`, {
      params: { technicalId },
    })
    .then((response) => {
      return response.data; // Return the data from the response
...
export const technicalExcelListing = (
  fromDate: string,
  todate: string,
  employeeId: string,
  type: string
  ...
  return http
    .get(`${API_URL}/TechnicalExcelListing`, {
...
export const getAllSections = (departmentId: string): Promise<any> => {
  return http
    .get(`${ROOT_API_URL}/GetAllSections`, {
      params: { departmentId },
    })
    .then((response) => {
      return response.data; // Return the data from the response
...
export const closeTechnical = (data: any): Promise<any> => {
  debugger;
  return http
    .post(`${API_URL}/CloseTechnical`, data)
...
export const technicalReviseList = (technicalId: string): Promise<any> => {
  return http
    .get(`${API_URL}/TechnicalReviseList`, {
      params: { technicalId },
    })
    .then((response) => {
      return response.data; // Return the data from the response
...
export const technicalReopen = (
  technicalId: string,
  userId: string,
  comment: string
): Promise<any> => {
  return http
    .post(`${API_URL}/TechnicalReopen`, null, {
      params: { technicalId, userId, comment },
    })
...
export const deleteTechnicalOutlineAttachment = (
  TechnicalOutlineAttachmentId: string
): Promise<any> => {
  return http
    .delete(`${API_URL}/TechnicalOutlineAttachment`, {
...
export const createTechnicalOutlineAttachment = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/CreateTechnicalOutlineAttachment`, data, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const changeRequestOwner = (
  technicalId: string,
  userId: string,
  comment: string
): Promise<any> => {
  return http
    .post(`${API_URL}/ChangeRequestOwner`, null, {
      params: { technicalId, userId, comment },
    })
...
export const updateOutlineEditor = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/UpdateOutlineEditor`, data, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const insertDelegate = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/InsertDelegate`, data, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const getEquipmentMasterTblList = (): Promise<any> => {
  return http
    .get(`${API_URL}/GetEquipmentMasterTblList`)
    .then((response) => {
      return response.data; // Return the data from the response
    })
    .catch((error) => {
...
export const getEquipmentMasterTblAddOrUpdate = (data: any): Promise<any> => {
  return http
    .post(`${API_URL}/GetEquipmentMasterTblAddOrUpdate`, data, {
      headers: {
        "Content-Type": "application/json",
      },
    })
...
export const getEquipmentMasterTblDelete = (Id: string): Promise<any> => {
  return http
    .delete(`${API_URL}/GetEquipmentMasterTblDelete`, {
      params: { Id: Id },
    })
    .then((response) => {
      return response.data; // Return the response data
